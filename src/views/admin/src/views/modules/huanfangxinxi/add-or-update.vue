<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="换房时间" prop="huanfangshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.huanfangshijian" 
                type="datetime"
                :readonly="ro.huanfangshijian"
                placeholder="换房时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.huanfangshijian" label="换房时间" prop="huanfangshijian">
              <el-input v-model="ruleForm.huanfangshijian" 
                placeholder="换房时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="换房原因" prop="huanfangyuanyin">
          <el-input v-model="ruleForm.huanfangyuanyin" 
              placeholder="换房原因" clearable  :readonly="ro.huanfangyuanyin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="换房原因" prop="huanfangyuanyin">
              <el-input v-model="ruleForm.huanfangyuanyin" 
                placeholder="换房原因" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kefangleixing = true;
          ...
          if(o=='huanfangshijian'){
            this.ruleForm.huanfangshijian = obj[o];
	    this.ro.huanfangshijian = true;
            continue;
          }
          if(o=='huanfangbianhao'){
            this.ruleForm.huanfangbianhao = obj[o];
	    this.ro.huanfangbianhao = true;
            continue;
          }
          if(o=='huanfangyuanyin'){
            this.ruleForm.huanfangyuanyin = obj[o];
	    this.ro.huanfangyuanyin = true;
            continue;
          }
          if(o=='zhanghao'){
