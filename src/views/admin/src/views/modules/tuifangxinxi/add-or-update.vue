<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="退房备注" prop="tuifangbeizhu">
          <el-input v-model="ruleForm.tuifangbeizhu" 
              placeholder="退房备注" clearable  :readonly="ro.tuifangbeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="退房备注" prop="tuifangbeizhu">
              <el-input v-model="ruleForm.tuifangbeizhu" 
                placeholder="退房备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
