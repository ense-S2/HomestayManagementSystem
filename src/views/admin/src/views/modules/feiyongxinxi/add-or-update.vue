<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="费用金额" prop="feiyongjine">
          <el-input v-model="ruleForm.feiyongjine" 
              placeholder="费用金额" clearable  :readonly="ro.feiyongjine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="费用金额" prop="feiyongjine">
              <el-input v-model="ruleForm.feiyongjine" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="费用描述" prop="feiyongmiaoshu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="费用描述"
                  v-model="ruleForm.feiyongmiaoshu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.feiyongmiaoshu" label="费用描述" prop="feiyongmiaoshu">
                    <span>{{ruleForm.feiyongmiaoshu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
