      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        ...
        >
          <el-form-item>
            ...
            <el-button
              v-if="
                isAuth('feiyongxinxi', '新增') && contents.btnAdAllIcon == 0
              "
              type="success"
              @click="addOrUpdateHandler()"
              >{{ contents.btnAdAllFont == 1 ? "新增" : "" }}</el-button
        ...
        >
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button
                v-if="
                  scope.row.ispay != '已支付' && isAuth('feiyongxinxi', '支付')
                "
                type="text"
                icon="el-icon-edit"
                size="small"
                @click="payHandler(scope.row)"
                >支付</el-button
              >
            </template>
          </el-table-column>
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button
                v-if="
                  isAuth('feiyongxinxi', '查看') && contents.tableBtnIcon == 0
                "
                type="success"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id, 'info')"
              ...
              <el-button
                v-if="
                  isAuth('feiyongxinxi', '修改') && contents.tableBtnIcon == 0
                "
                type="primary"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id)"
              ...
              <el-button
                v-if="
                  isAuth('feiyongxinxi', '删除') && contents.tableBtnIcon == 0
                "
                type="danger"
                size="mini"
                @click="deleteHandler(scope.row.id)"
