        ...
        >
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button
                v-if="
                  isAuth('xufangxinxi', '查看') && contents.tableBtnIcon == 0
                "
                type="success"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id, 'info')"
              ...
              <el-button
                v-if="
                  isAuth('xufangxinxi', '退房') && contents.tableBtnIcon == 0
                "
                type="success"
                size="mini"
                @click="
              ...
              <el-button
                v-if="
                  isAuth('xufangxinxi', '修改') && contents.tableBtnIcon == 0
                "
                type="primary"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id)"
              ...
              <el-button
                v-if="
                  isAuth('xufangxinxi', '删除') && contents.tableBtnIcon == 0
                "
                type="danger"
                size="mini"
                @click="deleteHandler(scope.row.id)"
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      if (
        this.searchForm.xuzhutianshu != "" &&
        this.searchForm.xuzhutianshu != undefined
      ) {
        params["xuzhutianshu"] = "%" + this.searchForm.xuzhutianshu + "%";
      }
      this.$http({
