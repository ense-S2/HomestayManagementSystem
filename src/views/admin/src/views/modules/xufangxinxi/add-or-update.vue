<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="续住时间" prop="xuzhushijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xuzhushijian" label="续住时间" prop="xuzhushijian">
              <el-input v-model="ruleForm.xuzhushijian" 
                placeholder="续住时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="续住备注" prop="xuzhubeizhu">
          <el-input v-model="ruleForm.xuzhubeizhu" 
              placeholder="续住备注" clearable  :readonly="ro.xuzhubeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="续住备注" prop="xuzhubeizhu">
              <el-input v-model="ruleForm.xuzhubeizhu" 
                placeholder="续住备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xufangxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
