    ...
    >
      <el-row>
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.kefangbianhao"
              placeholder="客房编号"
              clearable
              :readonly="ro.kefangbianhao"
            ></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          ...
          >
            <el-date-picker
              ...
              v-model="ruleForm.xuzhushijian"
              type="datetime"
              :readonly="ro.xuzhushijian"
              placeholder="续住时间"
            >
            </el-date-picker>
          </el-form-item>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.xuzhutianshu"
              placeholder="续住天数"
              clearable
              :readonly="ro.xuzhutianshu"
            ></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="续住天数" prop="xuzhutianshu">
              <el-input
                v-model="ruleForm.xuzhutianshu"
                placeholder="续住天数"
                readonly
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.xuzhubeizhu"
              placeholder="续住备注"
              clearable
              :readonly="ro.xuzhubeizhu"
            ></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="续住备注" prop="xuzhubeizhu">
              <el-input
                v-model="ruleForm.xuzhubeizhu"
                placeholder="续住备注"
                readonly
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        kefangbianhao: [],
        kefangleixing: [],
        kefangjiage: [{ validator: validateNumber, trigger: "blur" }],
        xuzhushijian: [],
        xuzhutianshu: [],
        xuzhubeizhu: [],
        zhanghao: [],
  ...
  computed: {},
  created() {
    this.ruleForm.xuzhushijian = this.getCurDateTime();
  ...
  methods: {
    ...
    init(id, type) {
      ...
      if (this.type == "info" || this.type == "else") {
        ...
        for (var o in obj) {
          ...
          if (o == "xuzhushijian") {
            this.ruleForm.xuzhushijian = obj[o];
            this.ro.xuzhushijian = true;
            continue;
          }
          if (o == "xuzhutianshu") {
          ...
          if (o == "xuzhubeizhu") {
            this.ruleForm.xuzhubeizhu = obj[o];
            this.ro.xuzhubeizhu = true;
            continue;
          }
          if (o == "zhanghao") {
    ...
    onSubmit() {
      this.$refs["ruleForm"].validate((valid) => {
        if (valid) {
          // 表单验证通过后提交数据
          this.$http({
            url: `xufangxinxi/${!this.ruleForm.id ? "save" : "update"}`, // 根据是否存在id决定是新增还是更新
            method: "post",
            ...
            .then(({ data }) => {
              if (data && data.code === 0) {
                ...
                this.$message({
                  ...
                  onClose: () => {
                    // 提交成功后的处理逻辑
                    this.parent.showFlag = true; // 隐藏子组件
                    this.parent.addOrUpdateFlag = false; // 关闭弹窗
                    this.parent.xufangxinxiCrossAddOrUpdateFlag = false; // 更新状态
                    this.parent.search(); // 调用父组件刷新列表
                    this.parent.contentStyleChange(); // 更新页面样式
                  },
                });
              } else {
                // 后端返回错误时提示
    ...
    back() {
      ...
      this.parent.xufangxinxiCrossAddOrUpdateFlag = false;
